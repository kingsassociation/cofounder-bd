          ...
          >
            ...
            <div className="col-span-1">
              ...
              <select
                ...
                className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-brand-500/20 outline-none bg-white"
              >
            ...
            <div className="col-span-1">
              ...
              <select
                ...
                className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-brand-500/20 outline-none bg-white disabled:opacity-50"
              >
            ...
            <div className="col-span-1 md:col-span-2 flex gap-3 mt-2">
              <button
                type="submit"
                disabled={saving}
                className="px-6 py-2 bg-brand-600 text-white font-semibold rounded-lg hover:bg-black transition-colors disabled:opacity-50 flex items-center gap-2"
              >
      ...
      {addresses.length === 0 ? (
        <div className="text-center py-12 bg-white rounded-xl border border-dashed border-neutral-300">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-gray-50 text-gray-700 font-medium rounded-lg hover:bg-gray-100 transition-colors"
          >
            Add Address
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
          {addresses.map((addr) => (
            <div
              key={addr.id}
              className={`p-5 rounded-xl border relative group transition-all ${addr.isPrimary ? "border-brand-600 bg-gray-50/50 shadow-sm" : "border-neutral-200 bg-white hover:border-gray-900"}`}
            >
              {addr.isPrimary && (
                <div className="absolute top-2 right-2 px-3 py-1 bg-gray-100 text-gray-700 text-xs font-bold rounded-full flex items-center gap-1">
