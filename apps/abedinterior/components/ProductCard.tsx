    ...
    <>
      ...
      >
        ...
        >
          ...
          />
          {product.category && (
            <div className="absolute top-2 left-2 bg-brand-600 text-white px-2.5 py-1 rounded-full text-xs font-semibold shadow-lg z-10">
              {product.category}
            </div>
          )}
          <WishlistButton
        ...
        <div className="p-3 sm:p-4">
          <Link href={productLink}>
            <h3 className="text-sm sm:text-base font-semibold text-gray-900 truncate hover:text-brand-600 transition-colors mb-1">
              {product.name}
            </h3>
          </Link>
          {}
          ...
          <div className="flex items-center justify-between gap-2 pt-2 border-t border-gray-100">
            ...
            <button
              ...
              className="px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm text-gray-700 border border-gray-300 rounded-full font-medium hover:bg-gray-50 hover:border-gray-900 hover:text-gray-900 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-md"
            >
              Add to Cart
            </button>
          </div>
