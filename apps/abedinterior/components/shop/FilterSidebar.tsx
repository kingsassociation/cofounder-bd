      ...
      >
        ...
        <div>
          ...
          <div className="space-y-2">
            <label className="flex items-center gap-2 cursor-pointer group">
              ...
              />
              <span
                className={`text-sm ${selectedCategory === "" ? "text-brand-600 font-semibold" : "text-gray-600 group-hover:text-gray-900"}`}
              >
                All Categories
              </span>
            </label>
            {categories.map((cat) => (
              ...
              >
                ...
                />
                <span
                  className={`text-sm ${selectedCategory === cat ? "text-brand-600 font-semibold" : "text-gray-600 group-hover:text-gray-900"}`}
                >
                  {cat}
                </span>
              </label>
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none bg-white"
          >
