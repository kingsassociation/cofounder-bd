  ...
  async () => {
    ...
    for (const cat of categories) {
      ...
      const groupedProducts = await prisma.product.findMany({
        where: { brandId: "abedinterior", category: cat.category },
        orderBy: { createdAt: "desc" },
        take: 8, 
        include: {
          images: {
            ...
            <div key={category} className="space-y-8">
              <div className="flex items-end justify-between border-b border-gray-100 pb-4">
                ...
                <Link 
                  ...
                  className="group flex items-center gap-2 text-brand-600 font-semibold hover:text-black transition-colors"
                >
                  Shop Now
